...
#define MIPI_FREQ_960M			960000000
#define MIPI_FREQ_1200M			1200000000
...
// #define IMX415_XVCLK_FREQ		27000000
#define IMX415_XVCLK_FREQ		24000000
...
//fps：30fps@24M 45fps@37.125M
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_360M_24M_regs[] = {
	{0x3008, 0x54},
	{0x300A, 0x3b},
	{0x3034, 0x09},
	{0x3115, 0x00},
...
//fps：30fps@24M 45fps@37.125M
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_720M_24M_regs[] = {
	{0x3008, 0x54},
	{0x300A, 0x3b},
	{0x3034, 0x09},
	{0x3115, 0x00},
...
// 40fps@24M
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_960M_24M_regs[] = {
	{0x3008, 0x54},
	{0x300A, 0x3b},
	{0x3034, 0x08},
	{0x3115, 0x00},
...
// 50fps@24M
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_1200M_24M_regs[] = {
	{0x3008, 0x54},
	{0x300A, 0x3b},
	{0x3034, 0x08},
	{0x3115, 0x00},
...
// 60fps@24M
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_1440M_24M_regs[] = {
	{0x3008, 0x54},
	{0x300A, 0x3b},
	{0x3034, 0x08},
	{0x3115, 0x00},
...
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_594M_27M_regs[] = {
	{0x4004, 0xc0},
	{0x4005, 0x06},
	{0x3008, 0x5d},
	{0x300A, 0x42},
...
// fps:30hz  freq:446M，297M,594
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_891M_27M_regs[] = {
	{0x4005, 0x06},
	{0x4004, 0xc0},
	{0x3008, 0x5d},
	{0x300A, 0x42},
...
// can not be used
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_1485M_27M_regs[] = {
	{0x4005, 0x06},
	{0x4004, 0xc0},
	{0x3008, 0x5d},
	{0x300A, 0x42},
...
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_596M_37M_regs[] = {
	{0x3020, 0x00},
	{0x3021, 0x00},
	{0x3022, 0x00},
	{0x3024, 0xCA},
...
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_891M_37M_regs[] = {
	{0x3008, 0x7f},
	{0x300a, 0x5b},
	{0x3034, 0x05},
	{0x3115, 0x00},
...
static __maybe_unused const struct regval imx415_linear_10bit_3864x2192_1485M_37M_regs[] = {
	{0x3020, 0x00},
	{0x3021, 0x00},
	{0x3022, 0x00},
...
int __imx415_power_on(struct imx415 *imx415)
{
	...
	/* fix power on timing if insmod this ko */
	usleep_range(10 * 1000, 20 * 1000);
	ret = clk_set_rate(imx415->xvclk, IMX415_XVCLK_FREQ);
	if (ret < 0)
		dev_warn(dev, "Failed to set xvclk rate\n");
	if (clk_get_rate(imx415->xvclk) != IMX415_XVCLK_FREQ)
